...
function AeroOAuthServer(options) {
  options = options || {};
...
AeroOAuthServer.prototype.authenticate = function(options) {
  var that = this;
...
AeroOAuthServer.prototype.authorize = function(options) {
  var that = this;
...
AeroOAuthServer.prototype.token = function(options) {
  var that = this;
...
module.exports = AeroOAuthServer;